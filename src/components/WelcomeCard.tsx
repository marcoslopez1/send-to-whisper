...
const WelcomeCard: React.FC<{ onDismiss: () => void }> = ({ onDismiss }) => {
  return (
    <div className="bg-gradient-to-br from-primary/10 to-accent/30 rounded-lg shadow-sm border border-primary/10 p-6 mb-6 relative">
      <button
        onClick={onDismiss}
      ...
      <h2 className="text-xl font-bold text-gray-900 mb-3">Welcome to Whisper Scribe</h2>
